...
public class ByteOrderMarkTest  {
    ...
    public void testConstantCharsetNames() {
        assertNotNull("ByteOrderMark.UTF_8.getCharsetName sendo carregado como java.nio.charset.Charset", Charset.forName(ByteOrderMark.UTF_8.getCharsetName()));
        assertNotNull("ByteOrderMark.UTF_16BE.getCharsetName sendo carregado como java.nio.charset.Charset", Charset.forName(ByteOrderMark.UTF_16BE.getCharsetName()));
        assertNotNull("ByteOrderMark.UTF_16LE.getCharsetName sendo carregado como java.nio.charset.Charset", Charset.forName(ByteOrderMark.UTF_16LE.getCharsetName()));
        assertNotNull("ByteOrderMark.UTF_32BE.getCharsetName sendo carregado como java.nio.charset.Charset", Charset.forName(ByteOrderMark.UTF_32BE.getCharsetName()));
        assertNotNull("ByteOrderMark.UTF_32LE.getCharsetName sendo carregado como java.nio.charset.Charset", Charset.forName(ByteOrderMark.UTF_32LE.getCharsetName()));
    }
